...
public class GameView extends JWindow {
	...
	protected void configure() {
		...
		// create a label
		finishDialog.setContentPane(new JLabel(new ImageIcon((getClass().getClassLoader().getResource("gameend.png")))));
		...
		aboutDialog.setContentPane(new JLabel(new ImageIcon((getClass().getClassLoader().getResource("gameabout.png")))));
