...
public class GameController extends JFrame implements ActionListener {
	...
	/**
	 * check - to check if its string or number finish - if game is finished
	 */
	...
	public void startTimer() {
		...
		timerTask = new TimerTask() {
			public void run() {
				...
				view.getTfTime().setText(
						String.format(" %02d:%02d:%02d", model.getHours(), model.getMinutes(), model.getSeconds()));
				check = true;
			}
		};
		try {
	...
	public void display() {
		...
		view.getTfPoints().setText(String.format(" %02d", model.points));
		view.getTfTime()
				.setText(String.format(" %02d:%02d:%02d", model.getHours(), model.getMinutes(), model.getSeconds()));
	...
	/**
	 * this method overrides the action performed to perform tasks based on events
	 * 
	...
	public void actionPerformed(ActionEvent e) {
		...
		int numTiles;
		if (e.getSource() == view.getDimComboBox() || e.getSource() == view.getTypeComboBox()) { // defines action for
																									// comboboxes
		...
		} else if (e.getSource() == view.getShow() || e.getSource() == view.getSolution()) { // defines the action for
																								// show or solution
			String text1 = view.getTfLetters().getText();
		...
		} else if (e.getSource() == view.getColor() || e.getSource() == view.getColor1()
				|| e.getSource() == view.getColor2()) {
			...
			if (e.getSource() == view.getColor1()) {
				...
				newColor_1 = JColorChooser.showDialog(view.getFrame(), "New Color",
						view.getGridObject().getForeground());
